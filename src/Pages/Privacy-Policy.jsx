...
export const PrivacyPolicy = () => {
  return (
    <Layout>
      <div className="container my-3 mx-auto px-3 md:w-10/12">
        <h1 className="bg-indigo-600 px-1 py-6 text-center text-4xl font-semibold text-white">
          Privacy Policy
        </h1>
        <p className="bg-indigo-600 sm:text-lg px-1 pb-6 text-center text-white">
          Please read this agreement carefully, as it contains important
          information regarding your legal rights and remedies
        </p>
      </div>
      <div className="policy container mx-auto px-3 md:w-10/12">
        <p>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Alcodemy Blog.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Alcodemy Blog, accessible from{" "}
              <a
                href="https://blog.alcodemy.tech"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://blog.alcodemy.tech
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            <p>By email: <a href="mailto:support@alcodemy.tech">support@alcodemy.tech</a></p>
          </li>
          <li>
            <p>
              By visiting this page on our website:{" "}
              <a
                href="https://blog.alcodemy.tech/contact"
                target="_blank"
              >
                https://blog.alcodemy.tech/contact
              </a>
            </p>
          </li>
        </ul>
